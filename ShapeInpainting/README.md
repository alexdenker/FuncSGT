...
- **test_funDPS.py**: evaluating the FunDPS guidance approximation
- **test_conditional.py**: evaluate the trained conditional diffusion model
- **test_sgt.py**: evaluate the trained guidance term using our SGT framework